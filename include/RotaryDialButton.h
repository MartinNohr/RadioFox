...
inline std::queue<enum CRotaryDialButton::Button> CRotaryDialButton::btnBuf;
inline gpio_num_t CRotaryDialButton::gpioNums[CLICK_BUTTONS_COUNT] = {};
inline gpio_num_t CRotaryDialButton::gpioA, CRotaryDialButton::gpioB, CRotaryDialButton::gpioC;
inline gpio_num_t CRotaryDialButton::gpioBtn0, CRotaryDialButton::gpioBtn1;
inline gpio_num_t CRotaryDialButton::gpioAltLeft, CRotaryDialButton::gpioAltRight;
inline int CRotaryDialButton::m_nLongPressTimer;
inline int CRotaryDialButton::m_nWhichButton;
inline esp_timer_handle_t CRotaryDialButton::periodic_LONGPRESS_timer;
inline esp_timer_create_args_t CRotaryDialButton::periodic_LONGPRESS_timer_args;
inline CRotaryDialButton::ROTARY_DIAL_SETTINGS* CRotaryDialButton::pSettings = { NULL };
inline CRotaryDialButton::Button CRotaryDialButton::longpressBtnArray[CLICK_BUTTONS_COUNT] = { CRotaryDialButton::BTN_LONGPRESS,CRotaryDialButton::BTN0_LONGPRESS,CRotaryDialButton::BTN1_LONGPRESS,CRotaryDialButton::BTN_LEFT_LONG,CRotaryDialButton::BTN_RIGHT_LONG };
inline CRotaryDialButton::Button CRotaryDialButton::clickBtnArray[CLICK_BUTTONS_COUNT] = { CRotaryDialButton::BTN_CLICK,CRotaryDialButton::BTN0_CLICK,CRotaryDialButton::BTN1_CLICK,CRotaryDialButton::BTN_LEFT,CRotaryDialButton::BTN_RIGHT };
inline portMUX_TYPE CRotaryDialButton::buttonMux = portMUX_INITIALIZER_UNLOCKED;
inline int CRotaryDialButton::m_nWaitRelease = 0;
inline int CRotaryDialButton::m_nButtonTimer = -1;
inline ESP32Encoder CRotaryDialButton::encoder;
